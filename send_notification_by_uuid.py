...
def sendMail(subject,to_email,content):
	...
	cc_msg.add_header('Reply-To','support@blah')
	cc_msg.add_header('From','support@blah')
	cc_msg['Subject'] = subject

	msg = MIMEText( msg1 + msg2,'plain','utf-8' )
	msg.add_header('Reply-To','support@blah')
	msg.add_header('From','support@blah')
	msg['Subject'] = subject
...
if __name__ == '__main__':
	...
	test_email = "blah@blah.com"
	subject = '[Notification] your subject'
